...
import { ListaComponent } from './paginas/meus-pedidos/lista/lista.component';
...
const appRoutes: Routes = [
  ...
  { path: 'meus-pedidos', component: ListaComponent, canActivate: [AuthGuard], data: {Animation: 'meus-pedidos'} },
  { path: 'detalhes-pedido', component: DetalhesComponent, canActivate: [AuthGuard], data: {Animation: 'detalhes-pedido'} },
